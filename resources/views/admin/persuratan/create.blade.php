        ...
        <form method="POST" action="{{ route('admin.persuratan.store') }}" enctype="multipart/form-data" style="max-width:600px;">
            ...
            <div class="form-row">
                <div class="form-group"><label>Agenda Surat</label>
                    <input type="text" name="agenda_surat" class="form-control" value="{{ old('agenda_surat') }}">
                </div>
            ...
            <div class="form-group"><label>Isi Disposisi</label>
                <textarea name="disposisi" class="form-control" readonly placeholder="Isi disposisi dikunci (locked)">{{ old('disposisi') }}</textarea>
            </div>
